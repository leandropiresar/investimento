        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Progress Bars</h6>
                            ...
                            <div class="widget-body clearfix">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mr-b-50">
                                        ...
                                        <p class="text-muted">Just add class <code>.progress-info</code> etc to <code>.progress-bar</code>
                                        </p>
                                        <div class="progress">
                                        ...
                                        <!-- /.progress -->
                                        <div class="progress">
                                            <div class="progress-bar bg-info" style="width: 20%" role="progressbar"><span class="sr-only">20% Complete</span>
                                            </div>
                                        </div>
                                        <!-- /.progress -->
                                        <div class="progress">
                                            <div class="progress-bar bg-success" style="width: 30%" role="progressbar"><span class="sr-only">20% Complete</span>
                                            </div>
                                        </div>
                                        <!-- /.progress -->
                                        <div class="progress">
                                    ...
                                    <div class="col-md-6 mr-b-50">
                                        ...
                                        <p class="text-muted">You can also add <code>.progress-striped</code> and <code>.progress-bar-animated</code>
                                        </p>
                                        ...
                                        <!-- /.progress -->
                                        <div class="progress progress-md">
                                            <div class="progress-bar bg-success progress-bar-striped" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100" style="width: 85%" role="progressbar"><span class="sr-only">85% Complete (success)</span>
                                            </div>
                                        </div>
                                        <!-- /.progress -->
                                        <div class="progress progress-md">
                                            <div class="progress-bar bg-success progress-bar-striped progress-bar-animated" style="width: 20%" role="progressbar"><span class="sr-only">20% Complete</span>
                                            </div>
                                        </div>
                                        <!-- /.progress -->
                                        <div class="progress progress-md">
                                            <div role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 20%" class="progress-bar bg-success progress-bar-striped progress-bar-animated"></div>
                                            <div role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 10%" class="progress-bar bg-info progress-bar-striped progress-bar-animated"></div>
                                            <div role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 15%" class="progress-bar bg-danger progress-bar-striped progress-bar-animated"></div>
                                            <div role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 30%" class="progress-bar bg-linkedin progress-bar-striped progress-bar-animated"></div>
                                        </div>
                                        <!-- /.progress -->
                                        <div class="progress progress-md">
                                            <div class="progress-bar bg-success" style="width: 70%" role="progressbar">70%</div>
                                        </div>
                                        <!-- /.progres -->
                                    </div>
                                    <!-- /.col-md-6 -->
                                    ...
                                    <div class="col-md-6 mr-b-50">
                                        ...
                                        <p class="text-muted">Size whatever you want just add class <code>progress sm, md, lg</code>
                                        </p>
                                        <div class="progress">
                                            <div class="progress-bar bg-info" style="width: 20%" role="progressbar"><span class="sr-only">20% Complete</span>
                                            </div>
                                        ...
                                        <div class="progress progress-sm mb-3">
                                            <div class="progress-bar bg-info" style="width: 30%" role="progressbar"><span class="sr-only">30% Complete</span>
                                            </div>
                                        </div>
                                        <!-- /.progress -->
                                        <div class="progress progress-md">
                                            <div class="progress-bar bg-info" style="width: 60%" role="progressbar"><span class="sr-only">60% Complete</span>
                                            </div>
                                        </div>
                                        <!-- /.progress -->
                                        <div class="progress progress-lg">
                                            <div class="progress-bar bg-info" style="width: 80%" role="progressbar"><span class="sr-only">80% Complete</span>
                                            </div>
                                        </div>
                                        <!-- /.progress -->
                                    </div>
                                    ...
                                    <div class="col-md-6 mr-b-50">
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <div class="progress progress-md progress-vertical-top">
                                                <div class="progress-bar bg-warning" style="height: 70%" role="progressbar"><span class="sr-only">70% Complete</span>
                                                </div>
                                            </div>
                                            <!-- /.progress -->
                                            <div class="progress progress-md progress-vertical">
                                                <div class="progress-bar bg-info" style="height: 30%" role="progressbar"><span class="sr-only">30% Complete</span>
                                                </div>
                                            </div>
                                            <!-- /.progress -->
                                            <div class="progress progress-md progress-vertical">
                                                <div class="progress-bar progress-bar-striped bg-success" style="height: 50%" role="progressbar"><span class="sr-only">50% Complete</span>
                                                </div>
                                            </div>
                                            <!-- /.progress -->
                                            <div class="progress progress-md progress-vertical">
                                                <div class="progress-bar progress-bar-striped bg-pink progress-bar-animated" style="height: 40%" role="progressbar"><span class="sr-only">40% Complete</span>
                                                </div>
                                            </div>
                                            <!-- /.progress -->
                                        </div>
