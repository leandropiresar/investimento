        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Tabs</h6>
                            ...
                            <div class="widget-body">
                                ...
                                <div class="tabs">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li class="nav-item"><a class="nav-link active" href="#profile-tab" data-toggle="tab" aria-expanded="true">Profile</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link" href="#messages-tab" data-toggle="tab" aria-expanded="true">Messages</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link" href="#settings-tab" data-toggle="tab" aria-expanded="true">Settings</a>
                                        </li>
                                    </ul>
                                    <!-- /.nav-tabs -->
                            ...
                            <div class="widget-body clearfix">
                                ...
                                <div class="tabs">
                                    <ul class="nav nav-tabs nav-justified">
                                        <li class="nav-item"><a class="nav-link" href="#home-tab2" data-toggle="tab" aria-expanded="true">Home</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link active" href="#profile-tab2" data-toggle="tab" aria-expanded="true">Profile</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link" href="#messages-tab2" data-toggle="tab" aria-expanded="true">Messages</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link" href="#settings-tab2" data-toggle="tab" aria-expanded="true">Settings</a>
                                        </li>
                                    </ul>
                                    <!-- /.nav-tabs -->
                                    <div class="tab-content">
                        ...
                        <div class="widget-bg">
                            <div class="widget-body">
                                ...
                                <div class="tabs tabs-vertical tabs-vertical-right clearfix">
                                    <ul class="nav nav-tabs flex-column">
                                        <li class="nav-item active"><a class="nav-link" href="#home-tab-v2" data-toggle="tab" aria-expanded="true">Home</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link" href="#profile-tab-v2" data-toggle="tab" aria-expanded="true">Profile</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link" href="#messages-tab-v2" data-toggle="tab" aria-expanded="true">Messages</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link" href="#settings-tab-v2" data-toggle="tab" aria-expanded="true">Settings</a>
                                        </li>
                                    </ul>
                                    <!-- /.nav-tabs -->
                                    <div class="tab-content">
                        ...
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                ...
                                <div class="tabs tabs-bordered">
                                    <ul class="nav nav-tabs">
                                        <li class="nav-item active"><a class="nav-link" href="#home-tab-bordered-1" data-toggle="tab" aria-expanded="true">Home</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link" href="#profile-tab-bordered-1" data-toggle="tab" aria-expanded="true">Profile</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link" href="#messages-tab-bordered-1" data-toggle="tab" aria-expanded="true">Messages</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link" href="#settings-tab-bordered-1" data-toggle="tab" aria-expanded="true">Settings</a>
                                        </li>
                                    </ul>
                                    <!-- /.nav-tabs -->
                                    <div class="tab-content">
                        ...
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                ...
                                <div class="tabs tabs-vertical tabs-vertical-icons">
                                    <ul class="nav nav-tabs flex-column">
                                        <li class="nav-item active"><a class="nav-link" href="#home-tab-icon1" data-toggle="tab" aria-expanded="true"><i class="list-icon material-icons">home</i></a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link" href="#profile-tab-icon1" data-toggle="tab" aria-expanded="true"><i class="list-icon material-icons">person</i></a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link" href="#messages-tab-icon1" data-toggle="tab" aria-expanded="true"><i class="list-icon material-icons">mail_outline</i></a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link" href="#settings-tab-icon1" data-toggle="tab" aria-expanded="true"><i class="list-icon material-icons">settings</i></a>
                                        </li>
                                    </ul>
                                    <!-- /.nav-tabs -->
                                    <div class="tab-content">
