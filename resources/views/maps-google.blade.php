...
<body class="sidebar-dark sidebar-expand navbar-brand-dark header-light">
        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Google Maps</h6>
                    ...
                    <div class="col-md-12 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                ...
                                <div class="gmap" data-toggle="google-map" data-plugin-options='{"lat": 34.05, "lng": -78.72, "zoom": 5}'></div>
                                <!-- /.gmap -->
                            </div>
                            <!-- /.widget-body -->
                        </div>
                    ...
                    <div class="col-md-6 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                ...
                                <div class="gmap" data-toggle="google-map" data-plugin-options='{"lat": -12.043333, "lng": -77.028333}'>
                                    <div class="map-polygon" data-plugin-options='{ "paths" : [[-12.040397656836609,-77.03373871559225], [-12.040248585302038,-77.03993927003302], [-12.050047116528843,-77.02448169303511],	[-12.044804866577001,-77.02154422636042]] , "strokeColor": "#131540", "strokeOpacity": 0.6, "strokeWeight": 6}'></div>
                                    <!-- /.map-path -->
                                </div>
                                <!-- /.gmap -->
                            </div>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCO9v3UBJDfOTFC_wcIK7UzhLRjBWQIJ9M"></script>
