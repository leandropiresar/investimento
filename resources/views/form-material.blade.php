        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Material Design Form</h6>
                ...
                <div class="page-title-right d-none d-sm-inline-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Material Design Form</li>
                    </ol>
                </div>
                <!-- /.page-title-right -->
            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group form-control-icon form-control-icon-right">
                                                <div class="input-group"><i class="material-icons list-icon">file_download</i> 
