        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Charts Js Page</h6>
                ...
                <div class="page-title-right d-none d-sm-inline-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Charts Js Page</li>
                    </ol>
                </div>
                <!-- /.page-title-right -->
            </div>
                            ...
                            <div class="widget-body chart-widget clearfix">
                                <div class="card border-0">
                                    <div class="card-header border-0">
                                        <h5 class="sub-heading-font-family mt-3">Report Statistics</h5><span class="sub-heading-font-family mb-3">Period: 22 - 29 May 2016</span>
                                        <div style="height: 200px" class="my-4 pr-4">
                                            <canvas id="chartJsHorizontalBar"></canvas>
                                        </div>
                                    </div>
                                    <div class="card-footer py-4 d-flex">
                                        <h5 class="sub-heading-font-family mr-auto my-auto">Stacked Bar Chart</h5><a href="javascript:void(0);" class="btn btn-sm px-3 fs-14 btn-rounded btn-outline-info">View Demo</a>
                                    </div>
                                </div>
                                <!-- /.card -->
                            </div>
                        ...
                        <div class="widget-bg p-0">
                            <div class="widget-body chart-widget clearfix">
                                <div class="card border-0">
                                    ...
                                    <div class="card-footer py-4 d-flex">
                                        <h5 class="sub-heading-font-family mr-auto my-auto">Bar Chart</h5><a href="javascript:void(0);" class="btn btn-sm px-3 fs-14 btn-rounded btn-outline-info">View Demo</a>
                                    </div>
                                </div>
                                <!-- /.card -->
                            </div>
                        ...
                        <div class="widget-bg p-0">
                            <div class="widget-body chart-widget clearfix">
                                <div class="card border-0">
                                    ...
                                    <div class="card-footer py-4 d-flex">
                                        <h5 class="sub-heading-font-family mr-auto my-auto">Area Chart</h5><a href="javascript:void(0);" class="btn btn-sm px-3 fs-14 btn-rounded btn-outline-info">View Demo</a>
                                    </div>
                                </div>
                                <!-- /.card -->
                            </div>
                                ...
                                <div class="card border-0">
                                    <div class="card-header border-0">
                                        ...
                                        <div style="height: 200px" class="my-4 pr-3 pie-chart">
                                            ...
                                            <div><span class="counter display-4">75</span><span class="display-4">&#37;</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-footer py-4 d-flex">
                                        <h5 class="sub-heading-font-family mr-auto my-auto">Pie Chart</h5><a href="javascript:void(0);" class="btn btn-sm px-3 fs-14 btn-rounded btn-outline-info">View Demo</a>
                                    </div>
                                </div>
                                <!-- /.card -->
                            </div>
                            ...
                            <div class="widget-body chart-widget clearfix">
                                <div class="card border-0">
                                    <div class="card-header d-flex border-0 pt-4" style="background-color: #474b5e">
                                        <div class="card-header-left"><span class="sub-heading-font-family">Report</span>
                                            <h4 class="sub-heading-font-family my-2 text-inverse">90.2</h4>
                                            <div class="progress mb-2">
                                                <div class="progress-bar bg-warning" style="width: 60%" role="progressbar"><span class="sr-only">60% Complete</span>
                                                </div>
                                            </div><small class="sub-heading-font-family">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</small>
                                        </div>
                                    ...
                                    <div class="card-footer py-4 d-flex">
                                        <h5 class="sub-heading-font-family mr-auto my-auto">Report Statistics</h5><a href="javascript:void(0);" class="btn btn-sm px-3 fs-14 btn-rounded btn-outline-info">View Demo</a>
                                    </div>
                                </div>
                                <!-- /.card -->
                            </div>
                            ...
                            <div class="widget-body clearfix">
                                ...
                                <div class="chart-widget d-flex">
                                    ...
                                    <ul class="list-unstyled sub-heading-font-family my-auto">
                                        <li class="py-1"><i class="material-icons fs-18 mr-2" style="color: #6acbf8">fiber_manual_record</i>  <span><strong>06&#37;</strong> Outdoor</span>
                                        </li>
                                        <li class="py-1"><i class="material-icons fs-18 mr-2" style="color: #a88cd6">fiber_manual_record</i>  <span><strong>32&#37;</strong> Indoor</span>
                                        </li>
                                        <li class="py-1"><i class="material-icons fs-18 mr-2" style="color: #fe81a9">fiber_manual_record</i>  <span><strong>24&#37;</strong> Adventure</span>
                                        </li>
                                        <li class="py-1"><i class="material-icons fs-18 mr-2" style="color: #fcda6c">fiber_manual_record</i>  <span><strong>26&#37;</strong> Chill</span>
                                        </li>
                                        <li class="py-1"><i class="material-icons fs-18 mr-2" style="color: #81c685">fiber_manual_record</i>  <span><strong>12&#37;</strong> Park</span>
                                        </li>
                                        <li class="py-1"><i class="material-icons fs-18 mr-2" style="color: #b6fad5">fiber_manual_record</i>  <span><strong>06&#37;</strong> Travel</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
