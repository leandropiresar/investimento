...
<head>
    ...
    <link href="node_modules/tablesaw/dist/tablesaw.css" rel="stylesheet" type="text/css" />
...
<body class="sidebar-dark sidebar-expand navbar-brand-dark header-light">
        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Responsive Tables</h6>
    ...
    <script src="./node_modules/tablesaw/dist/tablesaw.jquery.js"></script>
    <script src="./node_modules/tablesaw/dist/tablesaw-init.js"></script>
