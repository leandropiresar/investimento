...
<body class="sidebar-dark sidebar-expand navbar-brand-dark header-light">
        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Vector Maps</h6>
                    ...
                    <div class="col-md-12 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                ...
                                <div class="vmap" style="height: 700px" data-toggle="vector-map" data-plugin-options='{"map":"world_en","scaleColors" : ["#f0eafc" , "#8253eb"], "label": "GDP of %p: $%v Billion",  "labelNaN" : "Data unavailable for %p", "valuesSrcFile": "assets/js/sample-data.json", "color": "#ddd"}'></div>
                                <!-- /.vmap -->
                            </div>
                            <!-- /.widget-body -->
                        </div>
                    ...
                    <div class="col-md-6 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                ...
                                <div class="vmap" data-toggle="vector-map" data-plugin-options='{"map":"argentina_en", "label": "You are on %p", "color" : "#DF8A03"}'></div>
                                <!-- /.vmap -->
                            </div>
                            <!-- /.widget-body -->
                        </div>
                    ...
                    <div class="col-md-6 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                ...
                                <div class="vmap" data-toggle="vector-map" data-plugin-options='{"map":"usa_en", "color": "#DFAF03"}'></div>
                                <!-- /.vmap -->
                            </div>
                            <!-- /.widget-body -->
                        </div>
                    ...
                    <div class="col-md-6 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                ...
                                <div class="vmap" data-toggle="vector-map" data-plugin-options='{"map":"germany_en", "color": "#2A2177"}'></div>
                                <!-- /.vmap -->
                            </div>
                            <!-- /.widget-body -->
                        </div>
                    ...
                    <div class="col-md-6 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                ...
                                <div class="vmap" data-toggle="vector-map" data-plugin-options='{"map":"australia_en", "color": "#1A4271"}'></div>
                                <!-- /.vmap -->
                            </div>
                            <!-- /.widget-body -->
                        </div>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jqvmap/1.5.1/maps/continents/jquery.vmap.australia.js"></script>
