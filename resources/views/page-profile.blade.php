                                ...
                                <div class="widget-user-profile">
                                    ...
                                    <div class="profile-body">
                                        ...
                                        <div class="profile-user-description mb-4">
                                            ...
                                            <a href="#" class="heading-font-family color-primary fs-12 fw-700">http://instagram.com/scott</a>
                                        </div>
                                        <!-- /.profile-user-description -->
                                        <div class="mb-5"><a href="./page-profile.html" class="btn btn-outline-primary btn-rounded btn-lg px-5 border-thick text-uppercase mr-2 mr-0-rtl ml-2-rtl fw-700 fs-11 heading-font-family">Edit Profile</a>  <a href="./page-profile.html" class="btn btn-primary btn-circle btn-md fs-18"><i class="feather feather-settings"></i></a>
                                        </div>
                                    </div>
                                    <!-- /.d-flex -->
                                        ...
                                        <div class="col-md-12">
                                            <div class="contact-details-cell"><small class="heading-font-family fw-500 w-25 align-self-start">Interests</small>
                                                <div class="flex-1"><a href="#" class="btn bg-info-contrast btn-xs fw-500 px-3">Books</a>  <a href="#" class="btn bg-info-contrast btn-xs fw-500 px-3">Reading</a>  <a href="#" class="btn bg-info-contrast btn-xs fw-500 px-3">Travel</a> 
                                                    <a href="#" class="btn bg-info-contrast btn-xs fw-500 px-3">Cycling</a>
                                                </div>
                                            </div>
                                            <!-- /.contact-details-cell -->
                                        </div>
                                            ...
                                            <header>
                                                <div class="clearfix">
                                                    ...
                                                    <div class="float-right float-left-rtl dropdown"><a href="javascript:void(0);" data-toggle="dropdown" class="dropdown-toggle"><i class="feather feather-settings list-icon text-muted fs-18"></i></a>
                                                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="#"><span class="d-flex align-items-end"><span class="flex-1">History</span> <span class="badge badge-pill badge-primary">7</span> </span></a><a class="dropdown-item" href="#"><span class="d-flex align-items-end"><span class="flex-1">Detailed Logs</span> <span class="badge badge-pill badge-primary">23</span> </span></a>
